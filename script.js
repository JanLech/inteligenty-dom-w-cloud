...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('turnOn').addEventListener('click', () =>
        changeStatus(
            'https://svr59.supla.org/direct/1049/5MbXSjX9rYU6f/turn-on',
            'status',
            'device-on',
            'ON',
            '#03AC13'
    ...
    document.getElementById('turnOff').addEventListener('click', () =>
        changeStatus(
            'https://svr59.supla.org/direct/1049/5MbXSjX9rYU6f/turn-off',
            'status',
            'device-off',
            'OFF',
            'rgb(255, 0, 0)'
    ...
    document.getElementById('turnOn2').addEventListener('click', () =>
        changeStatus(
            'https://svr59.supla.org/direct/1051/SccbofVyQkG9eJ/turn-on',
            'status2',
            'device-on',
            'ON',
            '#03AC13'
    ...
    document.getElementById('turnOff2').addEventListener('click', () =>
        changeStatus(
            'https://svr59.supla.org/direct/1051/SccbofVyQkG9eJ/turn-off',
            'status2',
            'device-off',
            'OFF',
            'rgb(255, 0, 0)'
